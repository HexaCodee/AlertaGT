...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        logger.LogInformation("Verificando conexión a MongoDB...");

        // Ejecutar datos semilla
        await DataSeeder.SeedAsync(context);

        logger.LogInformation("Inicialización de MongoDB completada exitosamente");
    }
    catch (Exception ex)
    {
        logger.LogError(ex, "Ocurrió un error al inicializar MongoDB");
